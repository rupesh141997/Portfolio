...
export default function Intro() {
  ...
  const onButtonClick = () => { 
    ...
    fetch('Rupesh_Charandas_Borkar.pdf').then(response => { 
        response.blob().then(blob => { 
            ...
            alink.href = fileURL; 
            alink.download = 'Rupesh_Charandas_Borkar.pdf'; 
            alink.click(); 
        }) 
    }) 
  }
